                ...
                case ROUND:
                  {
                    ...
                    for ( int j = 0; j <= deg; j++ )
                    {
                      ...
                      else
                      {
                        ...
                        const data_type k = 0.5519150244935105707435627227925666423361803947243088973369805374675870988527781759268533834535800161 / (eli::constants::math<data_type>::sqrt_two()-1);

                        // Fraction of radius to place cubic control point
                        data_type f = k * tan(theta / 8.0);
