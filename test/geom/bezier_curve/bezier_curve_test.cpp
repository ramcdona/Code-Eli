...
int main(int argc, char *argv[])
{
  ...
  if (rtn == EXIT_SUCCESS)
  {
    ...
    ts.add(std::unique_ptr<Test::Suite>(new bezier_curve_test_suite<float>()));
    ts.add(std::unique_ptr<Test::Suite>(new bezier_curve_test_suite<double>()));
    ts.add(std::unique_ptr<Test::Suite>(new bezier_curve_test_suite<long double>()));
