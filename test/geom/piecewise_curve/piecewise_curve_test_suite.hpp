...
//        octave_print(2, pwc1);
    ...
    void round_test()
    {
      ...
      pt0=pwc0.f(t[1]);
      pt1=pwc1.f(t[1]);
      ptref << static_cast<data_type>(0.0703916), static_cast<data_type>(1.7403), 0;
      TEST_ASSERT(pt0!=pt1);
      ...
      pt0=pwc0.f(t[0]);
      pt1=pwc1.f(t[0]);
      ptref << static_cast<data_type>(0.100047), static_cast<data_type>(0.241536), 0;
      TEST_ASSERT(pt0!=pt1);
      TEST_ASSERT((pt0-ptref).norm()<1e-4);
      ...
      pt0=pwc0.f(t[2]);
      pt1=pwc1.f(t[2]);
      ptref << static_cast<data_type>(0.917118), static_cast<data_type>(1), 0;
      TEST_ASSERT(pt0!=pt1);
      TEST_ASSERT((pt0-ptref).norm()<1e-4);
      pt0=pwc0.f(t[3]);
      pt1=pwc1.f(t[3]);
