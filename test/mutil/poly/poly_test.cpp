...
int main(int argc, char *argv[])
{
  ...
  if (rtn == EXIT_SUCCESS)
  {
    ...
    ts.add(std::unique_ptr<Test::Suite>(new poly_basic_test_suite<int>()));
    ts.add(std::unique_ptr<Test::Suite>(new poly_basic_test_suite<float>()));
    ts.add(std::unique_ptr<Test::Suite>(new poly_basic_test_suite<double>()));
    ts.add(std::unique_ptr<Test::Suite>(new poly_basic_test_suite<long double>()));
    ts.add(std::unique_ptr<Test::Suite>(new poly_math_test_suite<int>()));
    ts.add(std::unique_ptr<Test::Suite>(new poly_math_test_suite<float>()));
    ts.add(std::unique_ptr<Test::Suite>(new poly_math_test_suite<double>()));
    ts.add(std::unique_ptr<Test::Suite>(new poly_math_test_suite<long double>()));
    ts.add(std::unique_ptr<Test::Suite>(new poly_root_test_suite<float>()));
    ts.add(std::unique_ptr<Test::Suite>(new poly_root_test_suite<double>()));
    ts.add(std::unique_ptr<Test::Suite>(new poly_root_test_suite<long double>()));
